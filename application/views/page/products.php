                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input id="PD_IMAG" type="file" class="" name="PD_IMAG"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="" name="PD_NAME" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="0" value="0" class="" name="PD_COST" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">ราคาขาย</label>
                                    <input type="number" min="0" value="0" class="" name="PD_SELL" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">จำนวนสินค้า</label>
                                    <input type="number" min="0" value="0" class="" name="PD_ITEM" required>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">รายละเอียดเก็บสินค้า</label>
                                    <textarea name="PD_DETAILS" class="" cols="30" rows="2"
                                        required></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <form id="formSubmitEditProduct" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    <label for="" class="form-label">ชื่อสินค้า</label>
                                                    <input type="text" class="" name="PD_NAME" required value="${response.PD_NAME}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                            <label for="" class="form-label">ราคาต้นทุนสินค้า</label>
                                            <input type="number" min="0" class="" name="PD_COST" required  value="${response.PD_COST}">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                            <label for="" class="form-label">ราคาขาย</label>
                                            <input type="number" min="0" class="" name="PD_SELL" required  value="${response.PD_SELL}">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                            <label for="" class="form-label">จำนวนสินค้า</label>
                                            <input type="number" min="0"  class="" name="PD_ITEM" required value="${response.PD_ITEM}">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <form id="formSubmitAddItemProduct" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class='row' >
                                            <div class="col-sm-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="" class="form-label">จำนวนสินค้า</label>
                                                    <input type="number" min="0"  class="" name="TS_ITEM" required >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
